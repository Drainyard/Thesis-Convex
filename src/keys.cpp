...
static void MouseScrollCallback(GLFWwindow* window, double xScroll, double yScroll)
{
    ...
    inputState.xScroll = (float)xScroll;
    inputState.yScroll = (float)yScroll;
}
...
static void MousePositionCallback(GLFWwindow * window, double xPos, double yPos)
{
    ...
    {
        inputState.xPos = (float)xPos;
        inputState.yPos = (float)yPos;
        inputState.firstMouse = false;
    }
    
    inputState.xDelta = (float)(xPos - inputState.xPos) * inputState.sensitivity;
    inputState.yDelta = (float)(inputState.yPos - yPos) * inputState.sensitivity;
    inputState.xPos = (float)xPos;
    inputState.yPos = (float)yPos;
